...
void Exp_InstrumentInit() {
    ...
    light_sensors[0].sda_port_out = OPT4003_I2C_SDA_3_PORT;
    light_sensors[0].sda_port_in = OPT4003_I2C_SDA_3_PORT;
    light_sensors[0].sda_port_dir = OPT4003_I2C_SDA_3_PORT;
    light_sensors[0].sda_pin = OPT4003_I2C_SDA_3_PIN;
    light_sensors[0].scl_port_out = OPT4003_I2C_SCL_3_PORT;
    light_sensors[0].scl_port_in = OPT4003_I2C_SCL_3_PORT;
    light_sensors[0].scl_port_dir = OPT4003_I2C_SCL_3_PORT;
    light_sensors[0].scl_pin = OPT4003_I2C_SCL_3_PIN;
    OPT4003_Init(&light_sensors[0]);

    light_sensors[1].address = OPT4003_I2C_ADDR_1;
    light_sensors[1].sda_port_out = OPT4003_I2C_SDA_3_PORT;
    light_sensors[1].sda_port_in = OPT4003_I2C_SDA_3_PORT;
    light_sensors[1].sda_port_dir = OPT4003_I2C_SDA_3_PORT;
    light_sensors[1].sda_pin = OPT4003_I2C_SDA_3_PIN;
    light_sensors[1].scl_port_out = OPT4003_I2C_SCL_3_PORT;
    light_sensors[1].scl_port_in = OPT4003_I2C_SCL_3_PORT;
    light_sensors[1].scl_port_dir = OPT4003_I2C_SCL_3_PORT;
    light_sensors[1].scl_pin = OPT4003_I2C_SCL_3_PIN;
    OPT4003_Init(&light_sensors[1]);

    light_sensors[2].address = OPT4003_I2C_ADDR_3;
    light_sensors[2].sda_port_out = OPT4003_I2C_SDA_3_PORT;
    light_sensors[2].sda_port_in = OPT4003_I2C_SDA_3_PORT;
    light_sensors[2].sda_port_dir = OPT4003_I2C_SDA_3_PORT;
    light_sensors[2].sda_pin = OPT4003_I2C_SDA_3_PIN;
    light_sensors[2].scl_port_out = OPT4003_I2C_SCL_3_PORT;
    light_sensors[2].scl_port_in = OPT4003_I2C_SCL_3_PORT;
    light_sensors[2].scl_port_dir = OPT4003_I2C_SCL_3_PORT;
    light_sensors[2].scl_pin = OPT4003_I2C_SCL_3_PIN;
    OPT4003_Init(&light_sensors[2]);

    light_sensors[3].address = OPT4003_I2C_ADDR_2;
    light_sensors[3].sda_port_out = OPT4003_I2C_SDA_3_PORT;
    light_sensors[3].sda_port_in = OPT4003_I2C_SDA_3_PORT;
    light_sensors[3].sda_port_dir = OPT4003_I2C_SDA_3_PORT;
    light_sensors[3].sda_pin = OPT4003_I2C_SDA_3_PIN;
    light_sensors[3].scl_port_out = OPT4003_I2C_SCL_3_PORT;
    ...
    light_sensors[4].sda_port_in = OPT4003_I2C_SDA_1_PORT;
    light_sensors[4].sda_port_dir = OPT4003_I2C_SDA_1_PORT;
    light_sensors[4].sda_pin = OPT4003_I2C_SDA_1_PIN;
    light_sensors[4].scl_port_out = OPT4003_I2C_SCL_1_PORT;
    light_sensors[4].scl_port_in = OPT4003_I2C_SCL_1_PORT;
    light_sensors[4].scl_port_dir = OPT4003_I2C_SCL_1_PORT;
    light_sensors[4].scl_pin = OPT4003_I2C_SCL_1_PIN;
    OPT4003_Init(&light_sensors[4]);

    light_sensors[5].address = OPT4003_I2C_ADDR_3;
    light_sensors[5].sda_port_out = OPT4003_I2C_SDA_1_PORT;
    light_sensors[5].sda_port_in = OPT4003_I2C_SDA_1_PORT;
    light_sensors[5].sda_port_dir = OPT4003_I2C_SDA_1_PORT;
    light_sensors[5].sda_pin = OPT4003_I2C_SDA_1_PIN;
    light_sensors[5].scl_port_out = OPT4003_I2C_SCL_1_PORT;
    light_sensors[5].scl_port_in = OPT4003_I2C_SCL_1_PORT;
    light_sensors[5].scl_port_dir = OPT4003_I2C_SCL_1_PORT;
    light_sensors[5].scl_pin = OPT4003_I2C_SCL_1_PIN;
    OPT4003_Init(&light_sensors[5]);

    light_sensors[6].address = OPT4003_I2C_ADDR_2;
    light_sensors[6].sda_port_out = OPT4003_I2C_SDA_1_PORT;
    light_sensors[6].sda_port_in = OPT4003_I2C_SDA_1_PORT;
    light_sensors[6].sda_port_dir = OPT4003_I2C_SDA_1_PORT;
    light_sensors[6].sda_pin = OPT4003_I2C_SDA_1_PIN;
    light_sensors[6].scl_port_out = OPT4003_I2C_SCL_1_PORT;
    light_sensors[6].scl_port_in = OPT4003_I2C_SCL_1_PORT;
    light_sensors[6].scl_port_dir = OPT4003_I2C_SCL_1_PORT;
    light_sensors[6].scl_pin = OPT4003_I2C_SCL_1_PIN;
    OPT4003_Init(&light_sensors[6]);

    light_sensors[7].address = OPT4003_I2C_ADDR_1;
    light_sensors[7].sda_port_out = OPT4003_I2C_SDA_1_PORT;
    light_sensors[7].sda_port_in = OPT4003_I2C_SDA_1_PORT;
    light_sensors[7].sda_port_dir = OPT4003_I2C_SDA_1_PORT;
    light_sensors[7].sda_pin = OPT4003_I2C_SDA_1_PIN;
    light_sensors[7].scl_port_out = OPT4003_I2C_SCL_1_PORT;
    light_sensors[7].scl_port_in = OPT4003_I2C_SCL_1_PORT;
    light_sensors[7].scl_port_dir = OPT4003_I2C_SCL_1_PORT;
    light_sensors[7].scl_pin = OPT4003_I2C_SCL_1_PIN;
    OPT4003_Init(&light_sensors[7]);

    light_sensors[8].address = OPT4003_I2C_ADDR_2;
    light_sensors[8].sda_port_out = OPT4003_I2C_SDA_2_PORT;
    light_sensors[8].sda_port_in = OPT4003_I2C_SDA_2_PORT;
    light_sensors[8].sda_port_dir = OPT4003_I2C_SDA_2_PORT;
    light_sensors[8].sda_pin = OPT4003_I2C_SDA_2_PIN;
    light_sensors[8].scl_port_out = OPT4003_I2C_SCL_2_PORT;
    light_sensors[8].scl_port_in = OPT4003_I2C_SCL_2_PORT;
    light_sensors[8].scl_port_dir = OPT4003_I2C_SCL_2_PORT;
    light_sensors[8].scl_pin = OPT4003_I2C_SCL_2_PIN;
    OPT4003_Init(&light_sensors[8]);

    light_sensors[9].address = OPT4003_I2C_ADDR_1;
    light_sensors[9].sda_port_out = OPT4003_I2C_SDA_2_PORT;
    light_sensors[9].sda_port_in = OPT4003_I2C_SDA_2_PORT;
    light_sensors[9].sda_port_dir = OPT4003_I2C_SDA_2_PORT;
    light_sensors[9].sda_pin = OPT4003_I2C_SDA_2_PIN;
    light_sensors[9].scl_port_out = OPT4003_I2C_SCL_2_PORT;
    light_sensors[9].scl_port_in = OPT4003_I2C_SCL_2_PORT;
    light_sensors[9].scl_port_dir = OPT4003_I2C_SCL_2_PORT;
    light_sensors[9].scl_pin = OPT4003_I2C_SCL_2_PIN;
    OPT4003_Init(&light_sensors[9]);

    light_sensors[10].address = OPT4003_I2C_ADDR_1;
    light_sensors[10].sda_port_out = OPT4003_I2C_SDA_4_PORT;
    light_sensors[10].sda_port_in = OPT4003_I2C_SDA_4_PORT;
    light_sensors[10].sda_port_dir = OPT4003_I2C_SDA_4_PORT;
    light_sensors[10].sda_pin = OPT4003_I2C_SDA_4_PIN;
    light_sensors[10].scl_port_out = OPT4003_I2C_SCL_4_PORT;
    light_sensors[10].scl_port_in = OPT4003_I2C_SCL_4_PORT;
    light_sensors[10].scl_port_dir = OPT4003_I2C_SCL_4_PORT;
    light_sensors[10].scl_pin = OPT4003_I2C_SCL_4_PIN;
    OPT4003_Init(&light_sensors[10]);

    light_sensors[11].address = OPT4003_I2C_ADDR_3;
    light_sensors[11].sda_port_out = OPT4003_I2C_SDA_2_PORT;
    light_sensors[11].sda_port_in = OPT4003_I2C_SDA_2_PORT;
    light_sensors[11].sda_port_dir = OPT4003_I2C_SDA_2_PORT;
    light_sensors[11].sda_pin = OPT4003_I2C_SDA_2_PIN;
    light_sensors[11].scl_port_out = OPT4003_I2C_SCL_2_PORT;
    light_sensors[11].scl_port_in = OPT4003_I2C_SCL_2_PORT;
    light_sensors[11].scl_port_dir = OPT4003_I2C_SCL_2_PORT;
    light_sensors[11].scl_pin = OPT4003_I2C_SCL_2_PIN;
    OPT4003_Init(&light_sensors[11]);

    light_sensors[12].address = OPT4003_I2C_ADDR_4;
    light_sensors[12].sda_port_out = OPT4003_I2C_SDA_2_PORT;
    light_sensors[12].sda_port_in = OPT4003_I2C_SDA_2_PORT;
    light_sensors[12].sda_port_dir = OPT4003_I2C_SDA_2_PORT;
    light_sensors[12].sda_pin = OPT4003_I2C_SDA_2_PIN;
    light_sensors[12].scl_port_out = OPT4003_I2C_SCL_2_PORT;
    light_sensors[12].scl_port_in = OPT4003_I2C_SCL_2_PORT;
    light_sensors[12].scl_port_dir = OPT4003_I2C_SCL_2_PORT;
    light_sensors[12].scl_pin = OPT4003_I2C_SCL_2_PIN;
    OPT4003_Init(&light_sensors[12]);

    light_sensors[13].address = OPT4003_I2C_ADDR_3;
    light_sensors[13].sda_port_out = OPT4003_I2C_SDA_4_PORT;
    light_sensors[13].sda_port_in = OPT4003_I2C_SDA_4_PORT;
    light_sensors[13].sda_port_dir = OPT4003_I2C_SDA_4_PORT;
    light_sensors[13].sda_pin = OPT4003_I2C_SDA_4_PIN;
    light_sensors[13].scl_port_out = OPT4003_I2C_SCL_4_PORT;
    light_sensors[13].scl_port_in = OPT4003_I2C_SCL_4_PORT;
    light_sensors[13].scl_port_dir = OPT4003_I2C_SCL_4_PORT;
